...
class SqlBaseListener(ParseTreeListener):
    ...
    def enterChangeColumn(self, ctx:SqlBaseParser.ChangeColumnContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#changeColumn.
    def exitChangeColumn(self, ctx:SqlBaseParser.ChangeColumnContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#booleanDefaultSpatial.
    def enterBooleanDefaultSpatial(self, ctx:SqlBaseParser.BooleanDefaultSpatialContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#booleanDefaultSpatial.
    def exitBooleanDefaultSpatial(self, ctx:SqlBaseParser.BooleanDefaultSpatialContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#spatialpredicated.
    def enterSpatialpredicated(self, ctx:SqlBaseParser.SpatialpredicatedContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#spatialpredicated.
    def exitSpatialpredicated(self, ctx:SqlBaseParser.SpatialpredicatedContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#myexpressionlist1.
    def enterMyexpressionlist1(self, ctx:SqlBaseParser.Myexpressionlist1Context):
        pass

    # Exit a parse tree produced by SqlBaseParser#myexpressionlist1.
    def exitMyexpressionlist1(self, ctx:SqlBaseParser.Myexpressionlist1Context):
        pass


    # Enter a parse tree produced by SqlBaseParser#myexpressionlist2.
    def enterMyexpressionlist2(self, ctx:SqlBaseParser.Myexpressionlist2Context):
        pass

    # Exit a parse tree produced by SqlBaseParser#myexpressionlist2.
    def exitMyexpressionlist2(self, ctx:SqlBaseParser.Myexpressionlist2Context):
        pass
